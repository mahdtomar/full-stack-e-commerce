            ...
            <div className="container">
                ...
                <div className="products-container flex2">
                    {products?.map((product, i) => {
                        return <ProductCard key={i} title={product.title} img={product.image} price={product.basePrice} discount={product.discount} id={product._id} rating={product.rating} cloudinary_url={product.cloudinary_url} discountPercentage={product?.discountPercentage} basePrice={product.basePrice}/>
                    })}
