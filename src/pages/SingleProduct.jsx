    ...
    return (
        <>
            ...
            {error ? <>
                ...
                <Header id={product._id} title={product.title} briefDescription={product.briefDescription} price={product.basePrice} image={product.image} rating={product?.rating} discount={35} />
